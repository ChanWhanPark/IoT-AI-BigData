...
def get_request_url(url):
    ...
    req.add_header("X-Naver-Client-Id", 'azrzVQz_H9GIunJuTETm')
    req.add_header("X-Naver-Client-Secret", 'bY8lqjMUo4')
...
def getPostData(sNode, post, jsonResult):
    ...
    if (sNode == "news"):
        ...
        jsonResult.append({'title':title, 'description':description,
                           'link':link, 'postdate':postdate, 'bloggername':bloggername,
        ...
        jsonResult.append({'title':title, 'description':description,
                           'link':link, 'cafename':cafename, 'cafeurl':cafeurl})
